...
PGIRS sets SiliQun apart. While QuTiP~\cite{Johansson2012,Johansson2013} handles Phase~1 and Qiskit Pulse~\cite{Alexander2020} provides Phase~2, no existing framework integrates all five phases. Algorithm~\ref{alg:pgirs} formalizes this comprehensive methodology.
