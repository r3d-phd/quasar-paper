...
explored in the hierarchical curriculum design described in \S\ref{sec:validation}.
...
\textbf{Setup.}
Each target state is trained independently using SAC with the four-component adaptive reward function (Eq.~\ref{eq:reward}) for $6 \times 10^5$ environment steps
