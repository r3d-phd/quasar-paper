...
T7 & SAC-HMRL    & SAC + BRFD + HMRL   & This work (the DRL agent)                & \textbf{0.993} & \textbf{20,000} \\
\bottomrule
\end{tabular}
\end{table}
