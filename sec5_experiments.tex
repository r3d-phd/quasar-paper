...
\midrule
GHZ-3    & Biseparable (1 ebit)     & \textit{in progress} & --- & --- \\
W-3      & Genuine multipartite     & \textit{in progress} & --- & --- \\
Cluster-1D & Graph state (1D chain) & \textit{in progress} & --- & --- \\
Dicke-$k_3$ & Permutation-symmetric & \textit{in progress} & --- & --- \\
\bottomrule
\end{tabular}
\end{table}
