...
The SiliQun physics engine solves the Lindblad master equation defined in
Eq.~(\ref{eq:lindblad}) (\S\ref{subsec:lindblad}). The three noise
channels (amplitude damping, phase dephasing, and depolarising noise), the
Runge--Kutta integration scheme, and the GPU acceleration strategy are
described in full detail in that section and are not repeated here.
...
literature~\cite{Tanamoto2026}, and establishes that the GAA profile supports
